...
const ToggleThemeSwitch = () => {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    if (e.target.checked) setTheme(THEME.DARK)
    else setTheme(THEME.LIGHT)
  }

  return (
    <div className="theme-switch">
      <input className="theme-switch-input" type="checkbox" id="theme-toggle" onChange={handleChange} />
      <label className="theme-switch-label" htmlFor="theme-toggle">
        <svg
          className="sun"
          width="800px"
          height="800px"
